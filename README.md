...
`${GOPATH}/src/github.com/fupslot/fsstatbeat`
...
```
git remote set-url origin https://github.com/fupslot/fsstatbeat
...
in the same directory with the name fsstatbeat.
...
```
./fsstatbeat -c fsstatbeat.yml -e -d "*"
```
...
```
mkdir -p ${GOPATH}/src/github.com/fupslot/fsstatbeat
git clone https://github.com/fupslot/fsstatbeat ${GOPATH}/src/github.com/fupslot/fsstatbeat
```
